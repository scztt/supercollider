...
DebugTableEntry DebugTable::getPosition()
{
	return mCurrentPosition;
}

void DebugTable::advance()
{
	mTable.push_back(mCurrentPosition);
}

void DebugTable::addEntry(const DebugTableEntry& entry)
{
...
std::size_t DebugTable::size() const
{
  return mTable.size();
}

const std::deque<DebugTableEntry>& DebugTable::entries() const
{
  return mTable;
}
